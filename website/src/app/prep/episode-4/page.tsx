...
export const metadata: Metadata = {
  title: "Episode 4 Prep — CONTXT: Lukas Amacher | Let's Vibe!",
  description:
    "Recording prep for Episode 4. Seth hosts Lukas Amacher of CONTXT.",
};
    ...
    <div className="min-h-screen">
      ...
      <section className="border-b border-[var(--border)]">
        <div className="max-w-[700px] mx-auto px-6 py-16">
          ...
          <p className="text-[var(--muted)] mb-8 text-lg">Introduce Lukas, establish the world</p>
      ...
      <section className="border-b border-[var(--border)]">
        <div className="max-w-[700px] mx-auto px-6 py-16">
          ...
          <p className="text-[var(--muted)] mb-8 text-lg">How an art world collector became a vibecoding obsessive</p>
          ...
          <div className="space-y-6">
            <div className="p-5 bg-[var(--surface)] rounded-lg border border-[var(--border)]">
              ...
              <ul className="space-y-3 text-[var(--muted)] text-sm">
                ...
                <li>&rarr; &ldquo;David built a Claude Code to Figma pipeline &mdash; runs a hundred design iterations overnight. Tell me about that workflow.&rdquo;</li>
                ...
                <li>&rarr; &ldquo;David found a way to actually burn through his token allowance every night. What&apos;s the trick?&rdquo;</li>
              </ul>
            </div>

            <div className="p-5 bg-amber-50 rounded-lg border border-amber-200">
              <p className="text-sm font-medium text-amber-900 mb-2">David&apos;s Design Unlock (reference on air)</p>
              <p className="text-amber-800 italic">
